...
class StoreHours {
  ...
  function __construct($hours = array(), $exceptions = array(), $template = array()) {
    ...
    if(!isset($this->template['open'])) {
      $this->template['open'] = '<h3>Yes, we\'re open! Today\'s hours are {%hours%}.</h3><br><img class="featurette-image img-responsive center-block" data-src="holder.js/500x500/auto" src="/img/signs/open.png" alt="Generic placeholder image">';
    }
